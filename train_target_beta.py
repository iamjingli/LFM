...
from utils.net_utils_r1 import compute_h_score, load_llm_classes, get_ood_scores_clip
from utils.net_utils_r1 import set_logger, set_random_seed
...
def main(args):
    ...
    log = f"{args.target_label_type} {args.dataset} {args.s_idx}->{args.t_idx} index:{args.index} t:{args.beta}" \
          f" Best: H-Score: {best_h_score:.3f}, KnownAcc:{best_known_acc:.3f}, UnknownAcc:{best_unknown_acc:.3f}\n"
    with open("beta_23.txt", "a") as f:
        f.write(log)
