...
from utils.net_utils import compute_h_score, load_llm_classes, get_ood_scores_clip, test_scores_clip
...
def get_idx(args, dataloader):
    ...
    test_scores_clip(args, net, dataloader, llm_labels)
...
def main(args):
    ...
    for epoch_idx in range(args.epochs):
        ...
        with open("TMM_MR/test_class.txt", "a") as f:
            f.write("Current: H-Score:{:.3f}, KnownAcc:{:.3f}, UnknownAcc:{:.3f}".format(hscore, knownacc, unknownacc) + "\n")
